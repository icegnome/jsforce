 ...
 */
export default class RecordStream<R extends Record = Record> extends PassThrough {
    /**
     *
     */
    constructor();
...
export declare class Serializable<R extends Record = Record> extends RecordStream<R> {
     ...
     */
    stream(type?: string, options?: Object): Readable;
}
/**
...
export declare class Parsable<R extends Record = Record> extends RecordStream<R> {
     ...
     */
    stream(type?: string, options?: Object): Writable;

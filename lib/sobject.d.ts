...
import { Record, DescribeLayoutResult, DescribeCompactLayoutsResult, DescribeApprovalLayoutsResult, Optional, DmlOptions, SaveResult, RetrieveOptions, Schema, SObjectNames, SObjectRecord, SObjectInputRecord, SObjectUpdateRecord, SObjectFieldNames, FieldProjectionConfig, FieldPathSpecifier, FieldPathScopedProjection } from './types';
...
export default class SObject<S extends Schema, N extends SObjectNames<S>, FieldNames extends SObjectFieldNames<S, N> = SObjectFieldNames<S, N>, RetrieveRecord extends SObjectRecord<S, N, '*'> = SObjectRecord<S, N, '*'>, InputRecord extends SObjectInputRecord<S, N> = SObjectInputRecord<S, N>, UpdateRecord extends SObjectUpdateRecord<S, N> = SObjectUpdateRecord<S, N>> {
     ...
     * Upsert records
     */
    upsert(records: InputRecord[], extIdField: FieldNames, options?: DmlOptions): Promise<SaveResult[]>;
    upsert(records: InputRecord, extIdField: FieldNames, options?: DmlOptions): Promise<SaveResult>;
    upsert(records: InputRecord | InputRecord[], extIdField: FieldNames, options?: DmlOptions): Promise<SaveResult | SaveResult[]>;
    /**
     * Delete records
     */
     ...
     */
    listviews(): import("./util/promise").StreamPromise<any>;
    /**
     ...
     */
    quickActions(): import("./util/promise").StreamPromise<any>;
    /**
...
declare class ListView {
     ...
     */
    results(): import("./util/promise").StreamPromise<any>;
    /**
    ...
    }): import("./util/promise").StreamPromise<any>;
    /**
